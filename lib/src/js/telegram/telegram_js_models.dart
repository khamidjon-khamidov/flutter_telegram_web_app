...
part 'src/events/share_message_failed_result.dart';
...
part 'src/models/accelerometer/accelerometer_start_params.dart';
part 'src/models/accelerometer/accelerometer.dart';
...
part 'src/models/gyroscope/gyroscope_start_params.dart';
part 'src/models/gyroscope/gyroscope.dart';
