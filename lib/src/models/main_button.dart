...
class MainButton {
  ...
  void onClick(void Function() callback) => tg.MainButton.onClick(tg.JsDynamicCallback(callback));

  /// A method that removes the button press event handler.
  void offClick(void Function() callback) => tg.MainButton.offClick(tg.JsDynamicCallback(callback));
